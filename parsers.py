...
parser.add_argument('--semeval_dir', type=str, default='dataset/SemEval', help='SemEval dataset directory path.')
parser.add_argument('--yelp_dir', type=str, default='dataset/Yelp2018', help='Yelp2018 dataset directory path.')
...
parser.add_argument('--save_steps', type=int, default=None, help='checkpoint during training.')
