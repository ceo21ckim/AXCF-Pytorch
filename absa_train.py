...
from models.bert import BertABSATagger
...
if __name__ == '__main__':
    ...
    train_dataloader, _ = get_dataloader(args, tokenizer, mode='train')
    valid_dataloader = get_dataloader(args, tokenizer, mode='valid')
